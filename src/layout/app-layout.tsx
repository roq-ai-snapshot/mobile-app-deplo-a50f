...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'developer', 'tester'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bugs', path: '/bugs', entity: 'bug', service: AccessServiceEnum.PROJECT, icon: FiAlertTriangle },
    {
      name: 'Deployments',
      path: '/deployments',
      entity: 'deployment',
    ...
    { name: 'Tests', path: '/tests', entity: 'test', service: AccessServiceEnum.PROJECT, icon: FiCheckSquare },
