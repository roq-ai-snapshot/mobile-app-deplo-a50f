...
export function useDeploymentFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDeploymentFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.deployment.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDeploymentCount<T extends Prisma.deploymentCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.deploymentCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useDeploymentCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.deployment.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDeploymentFindManyWithCount<
  T extends Prisma.deploymentFindManyArgs,
  R extends { data: GetFindResult<Prisma.$deploymentPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.deploymentFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDeploymentFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.deployment.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDeploymentFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDeploymentFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.deployment.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTestFindMany<
  T extends Prisma.testFindManyArgs,
  R extends GetFindResult<Prisma.$testPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.testFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTestFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.test.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTestCount<T extends Prisma.testCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.testCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTestCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.test.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTestFindManyWithCount<
  T extends Prisma.testFindManyArgs,
  R extends { data: GetFindResult<Prisma.$testPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.testFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTestFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.test.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTestFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTestFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.test.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
