...
import { useDeploymentFindFirst, useRoqClient } from 'lib/roq';
...
function DeploymentViewPage() {
  ...
  const { data, error, isLoading } = useDeploymentFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('deployment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/deployments/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Deployment Name" text={data?.deployment_name} />

                <FormListItem label="Deployment Version" text={data?.deployment_version} />

                <FormListItem label="Deployment Status" text={data?.deployment_status} />
