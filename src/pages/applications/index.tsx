...
export function ApplicationListPage(props: ApplicationListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['app_name.contains', 'app_version.contains', 'app_status.contains'],
          ...params.filters,
        },
        'application',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'app_name', header: 'App Name', accessorKey: 'app_name' },
    { id: 'app_version', header: 'App Version', accessorKey: 'app_version' },
    { id: 'app_status', header: 'App Status', accessorKey: 'app_status' },
