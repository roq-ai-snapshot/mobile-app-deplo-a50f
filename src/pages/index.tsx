...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`mobile app deployment management `}</title>

        <meta
          name="description"
          content="Experience seamless mobile app deployment management. Streamline your processes, enhance efficiency, and take control of your app's lifecycle with Mobile App Deployment Management."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1601972602237-8c79241e468b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHB8ZW58MHx8fHwxNjk4OTg4MDU3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@abillion?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`abillion`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`mobile app deployment management `}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless mobile app deployment management. Streamline your processes, enhance efficiency, and take control of your app's lifecycle with Mobile App Deployment Management.`}
            </Text>
            <Box
